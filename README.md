...
To install my configuration, clone the repository and change the luks boot device in modules/boot.nix, to the installed device, and change the username in flake.nix, which has the place holder <USER>. Using my dotfiles, run nixupdate, and enjoy!
